...
search([0,1,2,3,4])->[0,2]
search([1,1,10,10])->[10,10]
*/
...
module.exports = {length,maxList,minList,sumAll,average,last,pop,invert,up,down,push,nthFibo,fiboList,preserveNumbers, insert,existsIn,removeX,removeAllX,greaterThan,lowerThan,orderIndex,orderInsert,mapeo,search,removeN,append};